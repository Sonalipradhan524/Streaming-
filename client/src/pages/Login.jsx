...
import { Lock, Mail, Loader2, Video } from 'lucide-react';
      ...
      <div className="auth-card glass-container glass-container-hover">
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: '2rem' }}>
          ...
          <p style={{ color: 'var(--text-muted)', fontSize: '0.875rem' }}>
            Stream, connect and share in real time
          </p>
        </div>
        ...
        <div style={{ textAlign: 'center', marginTop: '1.5rem', fontSize: '0.875rem' }}>
          ...
          <Link to="/register" style={{ color: 'var(--primary)', fontWeight: 600, textDecoration: 'none', transition: 'var(--transition-smooth)' }} onMouseOver={(e) => e.target.style.textDecoration = 'underline'} onMouseOut={(e) => e.target.style.textDecoration = 'none'}>
            Register here
          </Link>
        </div>
      </div>
